...
CREATE TABLE `poliklinik` (
  `idPoliklinik` int(11) NOT NULL AUTO_INCREMENT,
  `Poliklinik_isim` varchar(45) DEFAULT NULL,
...
INSERT INTO `poliklinik` VALUES (1,'KGB'),(2,'Goz'),(3,'Cildiye'),(4,'Genelcerrahi'),(5,'Uroloji');
