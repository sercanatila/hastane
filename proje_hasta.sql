...
CREATE TABLE `hasta` (
  ...
  `Hasta_isim` varchar(20) DEFAULT NULL,
  `Hasta_soyisim` varchar(20) DEFAULT NULL,
  `Hasta_tc` varchar(20) DEFAULT NULL,
...
INSERT INTO `hasta` VALUES (3,'Kuzey','Tekinoğlu','22334455667','asd'),(4,'Furkan','Ceylan','33445566778','asd'),(5,'Sercan','Atila','44556677889','asd'),(6,'Ömer','Kadir','11223344556','asd'),(10,'Servan','Kalas','88776655443','asd');
